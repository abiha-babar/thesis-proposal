...
Second, researchers have shown that large AI models can be made much smaller without losing much of their ability. Dettmers et al.\ \cite{dettmers2022llmint8} proved this in a detailed study, showing that a large AI can be compressed to use much less memory and still work well on a regular laptop. Frantar et al.\ \cite{frantar2022gptq} went even further, developing a method that compresses AI models even more efficiently. The most recent milestone in this direction is Gemma~4, released by Google DeepMind in April~2026: its edge variants are capable of running fully offline on a mobile phone, natively processing document images without a separate OCR engine, and all under the permissive Apache~2.0 licence \cite{gemma4_2026}. Collectively, these studies prove that running a capable AI on a normal laptop---or even a smartphone---is not just theory but present-day reality.
